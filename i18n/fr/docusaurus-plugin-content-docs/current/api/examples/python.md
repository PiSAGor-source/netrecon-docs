...
## Obtenir les correspondances CVE
...
```python
# Obtenir les alertes ouvertes high/critical
...
## Événements en temps réel via WebSocket
...
print(f"Key: {new_key['key']}")  # Sauvegardez-la — affichée une seule fois !
